...
We hit an error with "BA29BD", and [testing that URL](http://api.postcodes.io/postcodes/BA29BD) shows it returns 404. We need to allow for that to happen.
...
Now we should have a list of lat-longs.
