...
#Create a new data frame containing only one column and one cell
companynamesonlyall <- data.frame(c("IGNORE"))
#Rename the column so it's the same as the others
colnames(companynamesonlyall) <- c("name")
#Merge all three datasets
companynamesonlyall <- rbind(companynamesonly,companynamesonlyall,companynamesonlylr)
