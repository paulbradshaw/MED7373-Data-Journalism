...
Note that SQL struggles with some column names where R replaces spaces with full stops. 

```{r}
colnames(exes1718)
mpnamesonly <- sqldf("select MP.s.Name, Amount.Paid from exes1718")
```

One solution is to put it in ` marks:
