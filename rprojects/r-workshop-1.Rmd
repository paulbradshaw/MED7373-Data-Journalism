...
From here you can repeat similar approaches to other columns, other correlations, and even look for datasets to combine with this one.

For example: how would you create a dataset for just those schools within the local authority of Birmingham?
